...
# Reading the data -----------------------------------------------------------------------
fn <- list.files("parameter-estimates/", full.names = TRUE, pattern = "mcmc-unif-prior-PTHR.+\\.rds")
...
# Plotting ---------------------------------------------------------------------
plot_mae(x = maes[,1], y = maes[,2], fn = "fig/mcmc-analysis-uniform-prior-mae.svg")
plot_auc(x = geese_mae, y = aphylo_mae, fn = "fig/mcmc-analysis-uniform-prior-auc.svg")
