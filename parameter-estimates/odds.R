...
coefs <-
  c(
    ...
    `Num. of genes changing at duplication` = -1.84572360094238,
    `Gains 0 at duplication` = -1.13923449669951,
    `Gains 0 at speciation` = -2.49628371040314,
    `Loss 0 at speciation` = -3.69963383790813,
    `Root 1` = 5.8333765289455
  )[-c(1:2, 7)]
